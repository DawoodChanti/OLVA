...
# COPY RIGHT 
# Based on https://arxiv.org/pdf/2106.08188 OLVA paper.
# This code has been replicated by zihang-xu https://github.com/zihang-xu/ASC/blob/main/code/olva.py  based on the code of Dr. Chanti https://github.com/DawoodChanti/OLVA in tensorlfow.
...
def train(args,snapshot_path,exp_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(zip(trainloader_s,trainloader_t)):
            ...
            loss = loss_dice + loss_align * 0.1 + vae_loss + vae_loss2
            #
            optimizer.zero_grad()
            loss.backward()
            optimizer.step()
